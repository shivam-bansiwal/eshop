    ...
    if(request.method=="POST"):
        try:
            ...
            if(request.POST.get('black')=="2"):
                p.black=True
            if(request.POST.get('white')=="2"):
                p.white=True
            if(request.POST.get('pink')=="2"):
                p.pink=True
            if(request.POST.get('green')=="2"):
                p.green=True
            if(request.POST.get('xs')=="2"):
                p.xs=True
            if(request.POST.get('s')=="2"):
                p.s=True
...
def editProduct(request,num):
    ...
    if(request.method=="POST"):
        ...
        if (request.POST.get('white') == "2"):
            p.white = True
        if (request.POST.get('white') == "1"):
            p.white = False
        if (request.POST.get('pink') == "2"):
            p.pink = True
        if (request.POST.get('pink') == "1"):
            p.pink = False
        if (request.POST.get('green') == "2"):
            p.green = True
        ...
        if (request.POST.get('xs') == "2"):
            p.xs = True
        if (request.POST.get('xs') == "1"):
            p.xs = False
        if (request.POST.get('s') == "2"):
            p.s = True
        if (request.POST.get('s') == "1"):
            p.s = False
        if (request.POST.get('m') == "2"):
            p.m = True
